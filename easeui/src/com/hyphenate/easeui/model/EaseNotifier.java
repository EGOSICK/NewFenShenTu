...
//                    .setAutoCancel(false);
//
//            String customNotifyText = "新消息";
//            String customCotentTitle = notificationInfoProvider.getTitle(message);
//
//            int fromUsersNum = fromUsers.size();
//            String summaryBody = msgs[6].replaceFirst("%1", Integer.toString(fromUsersNum))
//                    .replaceFirst("%2", Integer.toString(notificationNum));
//
//            mBuilder.setContentTitle(customCotentTitle);
//            mBuilder.setTicker(customNotifyText);
...
//            String appname = "分身兔";//(String) packageManager.getApplicationLabel(appContext.getApplicationInfo());

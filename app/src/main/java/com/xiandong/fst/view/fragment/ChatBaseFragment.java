...
public class ChatBaseFragment extends EaseChatFragment implements EMMessageListener {
//
//    protected static final String TAG = "ChatBaseFragment";
...
//    protected ChatBaseFragment.GroupListener groupListener;
...
//    protected ChatBaseFragment.MyItemClickListener extendMenuItemClickListener;
//
//    @Override
...
//
//        extendMenuItemClickListener = new ChatBaseFragment.MyItemClickListener();
...
//                groupListener = new ChatBaseFragment.GroupListener();
...
//    }
//
//    String name, ava, otherName, otherAva;
//
//    public void setMyAttributes(String name, String ava) {  //, String otherName, String otherAva
//        this.name = name;
//        this.ava = ava;
//        this.otherAva = otherAva;
...
////            message.setAttribute("otherName",otherName);
////            message.setAttribute("otherAva" , otherAva);
//        }
//        if (chatFragmentHelper != null) {
//            //set extension
...
//        }
//        if (chatType == EaseConstant.CHATTYPE_SINGLE)
//            message.setAttribute("orderID", "");
//
//        if (chatType == EaseConstant.CHATTYPE_GROUP)
//            message.setAttribute("orderID", orderId);
//        Log.d("getOrderId", "111---" + orderId);
//        //send message

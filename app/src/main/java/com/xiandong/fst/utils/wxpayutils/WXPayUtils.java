...
public class WXPayUtils {
    ...
    public void registerAPP() {
        msgApi = WXAPIFactory.createWXAPI(context, Constant.WX_APPID, true);
    ...
    private void genPayReq() {
        ...
        req.timeStamp = String.valueOf(genTimeStamp());  //limit_pay","no_credit"
...
//                Toast.makeText(context, result.get("err_code_des").toString(), Toast.LENGTH_SHORT).show();
            }
